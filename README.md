...
- **[Janus (DeepSeek)](https://github.com/deepseek-ai/Janus)** ![GitHub stars](https://img.shields.io/github/stars/deepseek-ai/Janus?style=social) - Unified multimodal understanding and generation models. Autoregressive framework that decouples visual encoding for both understanding and generation tasks. Includes Janus-Pro, JanusFlow variants. MIT licensed.
- **[DeepSeek-VL2](https://github.com/deepseek-ai/DeepSeek-VL2)** ![GitHub stars](https://img.shields.io/github/stars/deepseek-ai/DeepSeek-VL2?style=social) - Advanced vision-language model with dynamic high-resolution vision encoder, Mixture-of-Experts architecture, and superior performance on visual question answering and OCR. MIT licensed.
- **[InternVL (OpenGVLab)](https://github.com/OpenGVLab/InternVL)** ![GitHub stars](https://img.shields.io/github/stars/OpenGVLab/InternVL?style=social) - Large-scale vision-language foundation model series (up to 72B parameters) with strong multimodal reasoning, OCR, and visual understanding capabilities. MIT licensed.
