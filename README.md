...
- **[LLaVA](https://github.com/haotian-liu/LLaVA)** ![GitHub stars](https://img.shields.io/github/stars/haotian-liu/LLaVA?style=social) - Visual Instruction Tuning framework built towards GPT-4V level capabilities. Pioneer in large language and vision models with end-to-end training pipelines. NeurIPS 2023 Oral. Apache 2.0 licensed.
- **[InternVL](https://github.com/OpenGVLab/InternVL)** ![GitHub stars](https://img.shields.io/github/stars/OpenGVLab/InternVL?style=social) - GPT-4o level open-source multimodal dialogue model family. State-of-the-art performance on vision-language benchmarks with scalable architecture. CVPR 2024 Oral. MIT licensed.
- **[Janus](https://github.com/deepseek-ai/Janus)** ![GitHub stars](https://img.shields.io/github/stars/deepseek-ai/Janus?style=social) - Unified multimodal understanding and generation models. Single framework for both visual comprehension and image generation tasks. MIT licensed.
...
- **[CogVLM](https://github.com/zai-org/CogVLM)** ![GitHub stars](https://img.shields.io/github/stars/zai-org/CogVLM?style=social) - State-of-the-art open visual language model achieving GPT-4V level performance. Strong capabilities in visual understanding, OCR, and visual reasoning. Apache 2.0 licensed.
