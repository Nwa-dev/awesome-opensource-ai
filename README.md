...
- **[Pachyderm](https://github.com/pachyderm/pachyderm)** ![GitHub stars](https://img.shields.io/github/stars/pachyderm/pachyderm?style=social) - Data-centric pipelines with immutable data versioning and lineage tracking. Kubernetes-native with autoscaling and parallel processing for language-agnostic ML workflows. Apache 2.0 licensed.
