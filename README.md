...
- **[Quivr](https://github.com/QuivrHQ/quivr)** ![GitHub stars](https://img.shields.io/github/stars/QuivrHQ/quivr?style=social) - Opinionated RAG framework for integrating GenAI into your apps. Focus on your product rather than the RAG plumbing. Easy integration with any LLM (GPT-4, Groq, Llama) and any vector store (PGVector, Faiss). Apache 2.0 licensed.
- **[RAGatouille](https://github.com/AnswerDotAI/RAGatouille)** ![GitHub stars](https://img.shields.io/github/stars/AnswerDotAI/RAGatouille?style=social) - Easily use and train state-of-the-art late-interaction retrieval methods (ColBERT) in any RAG pipeline. Designed for modularity and ease-of-use, backed by research. Apache 2.0 licensed.
- **[STORM](https://github.com/stanford-oval/storm)** ![GitHub stars](https://img.shields.io/github/stars/stanford-oval/storm?style=social) - LLM-powered knowledge curation system that researches a topic and generates a full-length report with citations. From Stanford OVAL. MIT licensed.
