...
- **[LlamaFirewall (Meta)](https://github.com/meta-llama/PurpleLlama/tree/main/LlamaFirewall)** - Open-source guardrail system for building secure AI agents. Detects prompt injection, agent misalignment, and insecure code through PromptGuard 2, Agent Alignment Checks, and CodeShield scanners. Part of PurpleLlama. BSD-3-Clause licensed.
