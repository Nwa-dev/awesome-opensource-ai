...
- **[TGI (Text Generation Inference)](https://github.com/huggingface/text-generation-inference)** ![GitHub stars](https://img.shields.io/github/stars/huggingface/text-generation-inference?style=social) - Hugging Face's production-grade LLM serving toolkit. High-performance text generation with Tensor Parallelism and dynamic batching. Powers Hugging Face Inference Endpoints and supports Llama, Falcon, StarCoder, GPT-NeoX, and more.
