...
- **[Luigi](https://github.com/spotify/luigi)** ![GitHub stars](https://github.com/spotify/luigi?style=social) - Python module for building complex pipelines of batch jobs. Handles dependency resolution, workflow management, visualization, and Hadoop integration. Built at Spotify and battle-tested in production. Apache 2.0 licensed.
...
- **[trlx](https://github.com/CarperAI/trlx)** ![GitHub stars](https://img.shields.io/github/stars/CarperAI/trlx?style=social) - Distributed training framework for RLHF with support for PPO, ILQL, and custom reward functions. Research-grade implementation from CarperAI with multi-GPU support. MIT licensed.
...
- **[Stanford Alpaca](https://github.com/tatsu-lab/stanford_alpaca)** ![GitHub stars](https://img.shields.io/github/stars/tatsu-lab/stanford_alpaca?style=social) - Code and documentation to train Stanford's Alpaca models. The pioneering instruction-following LLaMA fine-tuning project that sparked the open-source instruction tuning movement. Apache 2.0 licensed.
- **[Alpaca-LoRA](https://github.com/tloen/alpaca-lora)** ![GitHub stars](https://img.shields.io/github/stars/tloen/alpaca-lora?style=social) - Instruct-tune LLaMA on consumer hardware using LoRA. Low-rank adaptation implementation that made fine-tuning accessible with limited GPU memory. Apache 2.0 licensed.
